                    ...
                    <form method="POST" action="{{ route('keuzedelen.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="beschrijving" name="beschrijving" rows="4"
                                      ...
                                      required>{{ old('beschrijving') }}</textarea>
                            @error('beschrijving')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="allow_multiple" value="1" class="mr-2" {{ old('allow_multiple') ? 'checked' : '' }}>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <input type="number" id="min_deelnemers" name="min_deelnemers" value="{{ old('min_deelnemers') }}" 
                                       min="1"
                            ...
                            <div>
                                ...
                                <input type="number" id="max_deelnemers" name="max_deelnemers" value="{{ old('max_deelnemers') }}" 
                                       min="1"
                        ...
                        <div class="flex gap-4">
                            ...
                            <a href="{{ route('keuzedelen.index') }}" class="px-6 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-sm text-gray-700 uppercase tracking-widest hover:bg-gray-400 transition">
                                Annuleren
                            </a>
                        </div>
                    </form>
